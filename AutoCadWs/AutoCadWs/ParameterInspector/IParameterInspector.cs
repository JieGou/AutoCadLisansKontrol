    ...
    public class IncomingMessageLogger : IDispatchMessageInspector
    {
         ...
         System.ServiceModel.InstanceContext instanceContext)
        {
            ...
            try
            {
                ...
                _logger.InitiliazeProcess(new LogData() { AppName = AutoCadWs.Properties.Settings.Default.AppName, Id = guidId, StartTime = starttime, Ip = sourceIp, Host = host, Method = action });
